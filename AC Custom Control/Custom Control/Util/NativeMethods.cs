...
namespace AC_Control
{
    internal static class NativeMethods
    {
        ...
        public const uint DCX_CACHE = 0x2U;

        public const int DCX_CLIPCHILDREN = 0x8;

        public const uint DCX_CLIPSIBLINGS = 0x10U;

        public const uint RDW_FRAME = 0x400U;

        public const uint RDW_INVALIDATE = 0x1U;

        public const uint RDW_IUPDATENOW = 0x100U;

        public const uint SRCCOPY = 0xCC0020U;

        public const uint WM_ERASEBKGND = 0x14U;

        public const uint WM_NCPAINT = 0x85U;

        public const uint WM_PAINT = 0xFU;
